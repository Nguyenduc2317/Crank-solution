        ...
        While (rebargroup0 Is Nothing And rebargroup1 Is Nothing)
            Try
                ...
                If obj0 IsNot Nothing Then
                    ...
                    MessageBox.Show("Select first object" & rebargroup0.StartPoint.ToString() & rebargroup0.EndPoint.ToString())
                End If
                Dim obj1 As tsm.ModelObject = picker.PickObject(mui.Picker.PickObjectEnum.PICK_ONE_OBJECT, "Select second object")
